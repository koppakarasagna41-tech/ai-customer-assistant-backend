...
def test_security_validate_safe(base_client: TestClient):
    payload = {"prompt": "Hello, how can I configure a standard webhook?", "context_type": "chat"}
...
def test_security_moderate_allowed(base_client: TestClient):
    payload = {"content": "This is standard business documentation regarding billing procedures."}
