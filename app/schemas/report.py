...
class ReportRequest(BaseModel):
    ...
    days: int = Field(..., description="Number of days to include")
...
class ScheduledReportConfig(BaseModel):
    ...
    recipients: list[str] = Field(..., description="Recipient email list")
...
class ReportMetadata(BaseModel):
    report_id: str = Field(..., description="Unique ID of the generated report")
