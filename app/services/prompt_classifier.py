class PromptClassifier:
    def __init__(self):
        self.dev_keywords = {"debug", "test config", "system diagnostic", "container status", "inspect memory"}
        self.admin_keywords = {"database count", "flush cache", "reset server", "sudo", "system logs"}
    ...
    def classify(self, prompt: str) -> str:
        ...
        if any(kw in prompt_lower for kw in ["ticket", "help", "support", "refund", "issue", "problem", "error", "broken", "login"]):
