from app.services.prompt_sanitizer import get_prompt_sanitizer, PromptSanitizer
from app.services.jailbreak_detector import get_jailbreak_detector, JailbreakDetector
from app.services.injection_detector import get_injection_detector, InjectionDetector
from app.services.security_logger import get_security_logger, SecurityLogger
from app.schemas.security import PromptEvaluationResult, NormalizationDetails, InjectionAnalysis, JailbreakAnalysis
...
class PromptValidator:
    ...
    def validate_prompt(self, raw_prompt: str, user_id: str = None, ip: str = None) -> PromptEvaluationResult:
        # 1. Normalization
