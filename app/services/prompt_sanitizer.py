...
class PromptSanitizer:
    ...
    def normalize(self, prompt: str) -> Tuple[str, dict]:
        if not prompt:
            return "", {"original_length": 0, "cleaned_length": 0, "unicode_normalized": True, "hidden_chars_removed": 0}
    ...
    def sanitize(self, prompt: str) -> str:
        # Simple sanitization - strip unsafe script/html tags if present to prevent HTML/JS injection
