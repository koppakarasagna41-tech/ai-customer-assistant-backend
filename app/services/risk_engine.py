...
class RiskEngine:
    def __init__(self):
        self.security_patterns = (
            r"\b(hack|breach|exploit|unauthorized|leak|vulnerability|malware|compromise|security)\b"
        )
        self.churn_patterns = (
            r"\b(cancel|churn|refund|leaving|quit|stop subscription|chargeback|competitor)\b"
        )
    ...
    def assess_risk(self, text: str, escalation_score: float = 0.0) -> dict:
        ...
        return {"level": level, "score": score, "risk_types": risk_types}
