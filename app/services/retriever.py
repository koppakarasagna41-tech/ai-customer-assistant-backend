...
from app.schemas.retrieval import RetrievalFilter, RetrievedChunk, RetrievalResponse
...
class DocumentRetriever:
    ...
    Query -> Local Clean -> Semantic Rewrite -> Classification -> Vector Similarity -> Rerank -> Cache -> Output
    """
    def __init__(self):
