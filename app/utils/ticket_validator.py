...
# We will define standard exception classes locally or assume exceptions folder is used.
# Let's write standard custom exceptions inside utils/ticket_validator.py or create a simple exception file first, 
# or raise ValueError / HTTPException directly.
# Wait, let's raise custom ValueError / standard ValueError and map them in the exception handler or handle them in service.
# Let's write custom validator rules that are easy to use.
